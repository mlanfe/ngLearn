...
export class Provider6aComponent {
  ...
  constructor(newLogger: NewLogger, oldLogger: OldLogger) {
    ...
    newLogger.log('123')
    newLogger.log('123')
    console.log('=================a',oldLogger===newLogger, oldLogger.logs.length, newLogger.logs.length)
...
export class Provider6bComponent {
  ...
  constructor(newLogger: NewLogger, oldLogger: OldLogger) {
    ...
    newLogger.log('123')
    newLogger.log('123')
    console.log('=================b',oldLogger===newLogger,oldLogger.logs.length, newLogger.logs.length)
